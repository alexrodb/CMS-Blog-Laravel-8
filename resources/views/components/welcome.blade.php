<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        Laravel Jetstream proporciona un punto de partida hermoso y robusto para su próxima aplicación de Laravel. Laravel está diseñado para ayudarlo a construir su aplicación utilizando un entorno de desarrollo que es simple, poderoso y agradable. Creemos que le debería encantar expresar su creatividad a través de la programación, por lo que hemos dedicado tiempo a crear cuidadosamente el ecosistema de Laravel para que sea un soplo de aire fresco. Esperamos que te guste
    </div>
</div>
