            ...
            <div class="d-grid gap-3">
                ...
                <div class="col-12 mb-1 p-2">
                    <label class="mb-2">Nombre de la categoría</label>
                ...
                <div class="col-12 mb-1 p-2">
                <label class="mb-2">URL amigable de esta categoría</label>
                ...
                <div class="col-12 mb-1 p-2">
                <label class="mb-2">Descripción de esta categoría</label>
